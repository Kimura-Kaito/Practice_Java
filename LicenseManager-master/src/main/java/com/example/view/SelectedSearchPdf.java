...
public class SelectedSearchPdf extends AbstractPdfView {
	...
	protected void buildPdfDocument(Map<String, Object> model, Document doc, PdfWriter writer,
		...
		// ヘッダー文字列
		//String[] headers = { "取得資格", "社員番号", "氏名", "取得日", "届出日", "手当金額", "付与開始月", "備考" };
		String[] headers = { "取得資格", "社員番号", "氏名", "取得日", "届出日", "付与開始月", "備考" };

		// 列幅
		//int[] tableWidths = { 20, 9, 12, 10, 10, 9, 10, 20 };
		int[] tableWidths = { 20, 9, 12, 10, 10, 10, 20 };
